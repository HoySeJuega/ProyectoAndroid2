...
public class Crear_Equipo extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn7 = (ImageButton) findViewById(R.id.editText4);
        ...
        ImageButton btn10 = (ImageButton) findViewById(R.id.iB9);
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            ...
            case 2:
                ...
                btn7 = (ImageButton) findViewById(R.id.editText4);
            ...
            case 3:
                ...
                btn4.setX(35);
                btn5.setX(500);
                btn6 = (ImageButton) findViewById(R.id.editText4);
                btn6.setBackgroundDrawable(getResources().getDrawable(R.drawable.boton));
                btn6.setX(280);
                btn6.setY(430);
